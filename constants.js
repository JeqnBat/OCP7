...
// ADD NEW RESTAURANT FORM ___________________________*/
const form = [
  ...
  {'mainDiv': `<div id="map" class="h-100 w-100"></div>
               <div id="navColumn" class="h-100 text-dark">
                 <div id="streetView" class="w-100 h-25">
                   <div id="streetViewBlinder" class="w-100 h-100 bg-white" style="z-index:2;position:inherit;filter:invert(1);"></div>
                 </div>
                 <div id="nav" class="d-flex justify-content-center align-items-start">
                   <div id="leftNav" class="row no-gutters h-100 w-100">
                     ...
                     <div id="addRestaurantButton" class="col-6 p-2 text-center my-auto">
