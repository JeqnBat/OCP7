...
const twentyTwoHomeMessage =
 `<div id="twenty-two-message">
    <img src="../gif/facepalm2022.gif">
    <p>Le Token gratuit 'Google Clouds' utilisé pour développer ce projet est périmé !</p>
    <p>En conséquence, le code ici présent n'a plus accès aux API google Services, Places & Maps.</p>
    <p>Il demeure néanmoins intact et conforme à ce qu'il était le jour de sa validation par un
    mentor d'OpenClassRooms.</p>
    <p>Lisez-le en intégralité à <a href="https://github.com/JeqnBat/OCP7">cette adresse</a>, augmenté d'un
    Readme.md.</p>
    <p>Rendez-vous sur mon <a href="https://portfolio.jeanbaptistepellier.fr">portfolio</a> pour 
    d'imminentes mises à jour & de nombreux nouveaux projets !</p>
    <span>×</span> 
  </div>`